        ...
        if(report.emails){
            for(var i = 0; i < report.emails.length; i++){
                var msg = {
                    ...
                    subject:versionInfo.title+': ' + report.properties["reports.you-had"] + ' '+report.total_new+' ' +
                    report.properties["common.new-users"] + ' '+report.properties["reports.time-"+report.frequency]+'!', //.toLowerCase()
                    html: message
                };
